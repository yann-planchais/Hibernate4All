...
public class SecondReview {
	...
	@JoinColumn(name = "HeritageSecondeSolutionFilm_id")
	private HeritageSecondeSolutionFilm movie;

	public SecondReview setRating(Integer pRating) {
		rating = pRating;
		return this;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof SecondReview)) {
			return false;
		}

		SecondReview other = (SecondReview) obj;
