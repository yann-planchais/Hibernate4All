...
public class MovieRepositoryGenreTest {
	...
	public void save_nominal() {
		...
		List<MovieWithDescription> liste = repository.getAll();

		MovieWithDescription movie = new MovieWithDescription();
		movie.setName("The social network bis");
	...
	/**
	 * Le genre Action est déjà en base et on essaie de faire persisté un objet
	 * détaché
	 */
	@Test
